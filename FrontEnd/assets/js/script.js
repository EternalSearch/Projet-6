...
const showAddWorkModal = () => {
  ...
  const selectform = document.querySelector(".modal__form");
  const formsubmit = document.querySelector(".modal__form .modal__submit");
  const checkFormCompletion = ()=>{
    console.log("fonction checkFormCompletion se lance");
    
  const inputs = selectform.querySelectorAll(".js-formverify");
  let allFilled = true;
  ...
  formsubmit.disabled = !allFilled;
  }
  
  selectform.addEventListener('input',checkFormCompletion);
  checkFormCompletion();
...
returnArrow.addEventListener("click", () => {
  // Création d'un listener pour la flèche retour gauche
  formReset();
  showWorksModal();
});
...
const displayModal = (event) => {
  ...
  const modalButton = windowmodal.querySelector(
    ".modal__workslist .modal__submit"
  ...
  inputFile.addEventListener("change", () => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        document
          .querySelector(".modal__importimg")
